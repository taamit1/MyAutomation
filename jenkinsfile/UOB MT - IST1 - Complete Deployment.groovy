                    ...
                    stages {
                        stage('UOB Kill NA/DM') {
                            steps {
                                ...
                                sh "/usr/bin/ansible-playbook /usr/local/var/ansible/lfin/uat_dm/roles/arlm/arlm_jvmkilld/playbook.yaml -i /usr/local/var/ansible/lfin/uat_dm/environments/$ENVIRONMENT -f 5 -e vhost='$APP' -e finame='$FI_NAME' -vv"
                            }
                        }
