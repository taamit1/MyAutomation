...
$JAVA_HOME/jre/bin/java -DJENKINS_HOME=/packages/jenkins -jar ${cwd}/jenkins-cli.jar  -s http://192.168.186.51:9443/jenkins/ login --username admin --password p@s5w0rd

$JAVA_HOME/jre/bin/java -DJENKINS_HOME=/packages/jenkins -jar ${cwd}/jenkins-cli.jar  -s http://192.168.186.51:9443/jenkins/ reload-configuration --username admin --password p@s5w0rd
