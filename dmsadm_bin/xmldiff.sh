...
java -DIVB_HOME="$XMLDIFF" -classpath "$XMLDIFF/lib/xmldiff.jar:$XMLDIFF/lib/ivbjfaceall.jar:$XMLDIFF/lib/xml4j.jar:$XMLDIFF/config" com.ibm.ivb.xmldiff.XMLDiffUILauncher
