...
#ARLM_BIN="/support/bin502"
ARLM_BIN="/support/bin616"
...
#
# set PATH to include java6 for UB5.0 and higher
#
export ENVMGRLIB=$ARLM_BIN/envMgrCli/lib
case "$EP_VER_CUR" in
UB5.0*) PATH=/usr/java6_64/bin:$PATH
	  ENVMGRLIB=$ARLM_BIN/envMgrCli/lib
          echo "changing PATH for version $EP_VER_CUR"
          echo
;;
UB5.1*) PATH=/usr/java7_64/bin:$PATH
          ENVMGRLIB=$ARLM_BIN/envMgrCli/lib
          echo "changing PATH for version $EP_VER_CUR"
          echo
;;
OB3.8*) PATH=/usr/java6_64/bin:$PATH
          ENVMGRLIB=$ARLM_BIN/envMgrCli/lib
          echo "changing PATH for version $EP_VER_CUR"
          echo
;;
OB16.0*) PATH=/usr/java7_64/bin:$PATH
          ENVMGRLIB=$ARLM_BIN/envMgrCli/lib
          echo "changing PATH for version $EP_VER_CUR"
          echo
;;
